...
> Status: historical design record. VibeFlow 0.9 keeps first-class bounded or unbounded loop nodes; current behavior is documented in `developer_guide.md` and `js_aot_build.md`.
