...
from vibeflow.aot.project_build import ProjectBuildError
from vibeflow.cli import build_parser, main
...
def test_build_cli_prints_one_machine_readable_success_object(
    ...
    monkeypatch.setattr(
        "vibeflow.aot.project_build.build_project_aot",
...
def test_build_cli_preserves_stable_error_codes(
    ...
    monkeypatch.setattr("vibeflow.aot.project_build.build_project_aot", fail)
