...
REAL_TOOLCHAIN_ROOT = (
    REPOSITORY_ROOT / "examples" / "js_aot_minimal" / "project"
)
...
def test_build_profiles_are_atomic_and_manifest_is_deterministic(
    ...
    import vibeflow.aot.builder as builder_module
...
def test_toolchain_rejects_package_lock_version_mismatch(
    ...
    import vibeflow.aot.toolchain as toolchain_module
