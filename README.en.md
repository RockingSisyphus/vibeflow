...
> Executable flowchart discipline for vibe coding.

VibeFlow is a strict flowchart project skeleton for AI-assisted development. It helps you split business logic into small nodes, declare control flow explicitly in JSONC, and keep AI-generated changes inside a structure that can be checked, reviewed, and run.
