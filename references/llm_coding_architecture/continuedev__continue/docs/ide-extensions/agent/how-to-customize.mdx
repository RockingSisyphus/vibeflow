...
Adding Rules can be done in your local configuration. Refer to the [Rules deep dive](/customize/deep-dives/rules) for more details.
...
You can add MCP servers to your configuration to give Agent mode access to more tools. Consult the [MCP guide](/customize/deep-dives/mcp) for more details.
