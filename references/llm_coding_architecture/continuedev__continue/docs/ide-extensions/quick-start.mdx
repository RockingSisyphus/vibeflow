...
<Accordion title="Chat & Agent Mode Best Practices">
  Discover [effective prompting techniques](/customize/deep-dives/prompts), [configuration options](/guides/understanding-configs), and [custom slash
  commands](/customize/deep-dives/prompts).
</Accordion>

  <Accordion title="Enterprise & Teams">
    Explore [configuration options](/guides/understanding-configs) and [model providers](/customize/model-providers/overview) for team setups.
  </Accordion>
</AccordionGroup>
