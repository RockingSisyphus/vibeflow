...
<Warning>
  ...
  [Instinct](https://continue.dev/continuedev/instinct) or [Mercury Coder
  model](https://continue.dev/inception/mercury-coder) configured in
...
- **API Keys**: Users need to provide their own API keys in their [model configuration](/customize/model-providers/overview)
...
<Card title="Provide Feedback" icon="message">
  Have feedback? We want to hear it. __[File an issue on GitHub](https://github.com/continuedev/continue/issues)__
  to help us improve.
</Card>
