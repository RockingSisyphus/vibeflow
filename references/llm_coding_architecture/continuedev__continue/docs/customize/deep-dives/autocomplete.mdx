...
The `config.json` configuration format offers configuration options through `tabAutocompleteOptions`. See the [JSON Reference](/reference/json-reference#tabautocompleteoptions) for more details.
...
7. If you are still having issues, please file an issue on [GitHub](https://github.com/continuedev/continue/issues).
...
If you're turning off autocomplete, we'd love to hear how we can improve! Please file an issue on [GitHub](https://github.com/continuedev/continue/issues).
