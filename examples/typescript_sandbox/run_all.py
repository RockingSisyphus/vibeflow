...
from vibeflow.aot.errors import AotBuildError, ProjectBuildError
...
def main() -> int:
    ...
    parser.add_argument(
        "--puppeteer-root",
        type=Path,
        default=DEFAULT_PUPPETEER_ROOT,
    )
    ...
    with tempfile.TemporaryDirectory(prefix="vibeflow-ts-sandbox-") as raw:
