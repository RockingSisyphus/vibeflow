...
- [ ] `npm ci --prefix examples/typescript_sandbox/project && npm ci --prefix tools/mermaid-renderer`
- [ ] `PYTHONPATH=src python examples/typescript_sandbox/run_all.py --puppeteer-root tools/mermaid-renderer`
