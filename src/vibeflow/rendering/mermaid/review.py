...
def _mapping_items(value: object) -> tuple[Mapping[str, object], ...]:
    from vibeflow.rendering.mermaid import _mapping_items as impl

    return impl(value)


def _escape_label(value: str) -> str:
    from vibeflow.rendering.mermaid import _escape_label as impl

    return impl(value)


def _safe_id(value: str) -> str:
    from vibeflow.rendering.mermaid import _safe_id as impl
