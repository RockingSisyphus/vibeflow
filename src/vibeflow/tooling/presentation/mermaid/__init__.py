...
from vibeflow.tooling.presentation.helpers import compile_for_render, node_flow_kind, node_is_external, nodeset_for_node

from vibeflow.tooling.presentation.mermaid.labels import (
...
class _MermaidRenderer:
    ...
    def _render_review_columns(self, graph: GraphConfig, compiled: CompiledGraph) -> str:
        from vibeflow.tooling.presentation.mermaid.review import render_review_columns
