...
def _rendered_resources_payload(resources: object | None, graph: GraphConfig) -> Mapping[str, object]:
    from vibeflow.tooling.presentation.mermaid import _rendered_resources_payload as impl

    return impl(resources, graph)


def _mapping_items(value: object) -> tuple[Mapping[str, object], ...]:
    from vibeflow.tooling.presentation.mermaid import _mapping_items as impl

    return impl(value)


def _escape_label(value: str) -> str:
    from vibeflow.tooling.presentation.mermaid import _escape_label as impl

    return impl(value)


def _safe_id(value: str) -> str:
    from vibeflow.tooling.presentation.mermaid import _safe_id as impl
