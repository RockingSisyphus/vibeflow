...
from vibeflow.tooling.application.diagnostics import core_diagnostic_sink
from vibeflow.core.findings import HealthReport
from vibeflow.tooling.application.run_directory import InvalidRunIdError, parse_run_id_argument, validate_run_id
...
def handle_delegate_cli(args) -> int:
    from vibeflow.tooling.application.cli import _load_workspace_for_cli, _runtime_options_from_args
