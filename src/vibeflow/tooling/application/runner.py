...
from vibeflow.tooling.application.run_directory import (
...
from vibeflow.tooling.project.effective_policy import (
...
def _write_preflight_artifacts(run_dir: Path, graph: GraphConfig, compiled, health: HealthReport, *, registry: NodeRegistry | None = None, resources: ConfigResources | None = None) -> None:
    from vibeflow.tooling.presentation.architecture_document import render_architecture_document
    from vibeflow.tooling.presentation.ascii_flowchart import export_ascii_flowchart
    from vibeflow.tooling.presentation.mermaid import compiled_graph_payload, export_mermaid
    from vibeflow.tooling.presentation.mermaid.render import EXPANDED_MERMAID_MAX_EDGES, EXPANDED_MERMAID_MAX_TEXT_SIZE, MermaidRenderError, render_mermaid_svg
