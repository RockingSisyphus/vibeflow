...
from vibeflow.tooling.project.resource_helpers import _finding, _module_search_path, _resolve_paths
from vibeflow.tooling.project.host_extensions import (
...
from vibeflow.targets.python.project.resources import (
    ...
    normalize_base_lib_info as _normalize_base_lib_info,
...
def load_config_resources(
    ...
    *,
    ...
    from vibeflow.tooling.application.python.project.plugin_resources import plugin_resources
