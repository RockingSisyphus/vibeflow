...
from vibeflow.data_contract import CARDINALITY_EXACTLY_ONE, CARDINALITY_OPTIONAL_ONE
...
def _append_nodeset_flow_health(graph, state, *, registry, visited_nodesets: set[str]) -> None:
    ...
    from vibeflow.health.flow import append_flowchart_health, append_join_policy_health
