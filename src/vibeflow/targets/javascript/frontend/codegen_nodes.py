...
class NodeCodegenMixin:
    ...
    def _emit_activate(self, code: WorkflowCode, node: EmissionNode) -> str:
        routes = [
    ...
    @staticmethod
    def _emit_loop_collect(lines: list[str], node: EmissionNode) -> None:
    ...
    @staticmethod
    def _emit_loop_stop(lines: list[str], node: EmissionNode) -> None:
        spec = node.loop
    ...
    @staticmethod
    def _emit_loop_outputs(lines: list[str], node: EmissionNode) -> None:
