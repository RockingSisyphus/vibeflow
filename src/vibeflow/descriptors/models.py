...
from vibeflow.data_contract import CARDINALITIES, DataProvider, DataRequirement
...
from vibeflow.descriptors._resource_models import (  # noqa: E402
    BaseLibDescriptor,
...
for _resource_type in (
    ...
    _resource_type.__module__ = __name__
del _resource_type
